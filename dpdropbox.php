 ...
 */
class PlgFileSystemDpdropbox extends CMSPlugin implements ProviderInterface
{
	/**
	...
	public function onFileSystemOAuthCallback(\Joomla\Component\Media\Administrator\Event\OAuthCallbackEvent $event)
	{
		...
		if ($code != null)
		{
			...
			$redirectURI  = Joomla\CMS\Uri\Uri::root() . 'administrator/' .
							'index.php?option=com_media&task=plugin.oauthcallback&plugin=dpdropbox';
	...
	public function getAdapters()
	{
		...
		$dropbox = new \DigitalPeak\Plugin\Filesystem\Dpdropbox\Adapter\DPDropboxAdapter($accessToken);
